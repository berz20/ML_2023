...
"Exploring QCD matter in extreme conditions with Machine Learning", 23, 03
"Exotic Tetraquark states with two $\bar{b}$-quarks and $J^P", 23, 03
...
"Measurement of the cross section of top quark-antiquark pair production in association with a W boson in proton-proton collisions at $\sqrt{s}", 22, 12
"Evidence for Four-Top Quark Production at the LHC", 22, 12
"Search for long-lived particles using out-of-time trackless jets in proton-proton collisions at $ \sqrt{s} $", 22, 12
"Search for a new scalar resonance in flavour-changing neutral-current top-quark decays $t \rightarrow qX$ ($q", 23, 01
"Search for periodic signals in the dielectron and diphoton invariant mass spectra using 139 fb$^{-1}$ of $pp$ collisions at $\sqrt{s}", 23, 05
"Search for a new Z' gauge boson in $4\mu$ events with the ATLAS experiment", 23, 01
"Observation of single-top-quark production in association with a photon using the ATLAS detector", 23, 02
"Search for a light charged Higgs boson in $t \rightarrow H^{\pm}b$ decays, with $H^{\pm} \rightarrow cb$, in the lepton+jets final state in proton-proton collisions at $\sqrt{s}", 23, 02
"Search for third-generation vector-like leptons in $pp$ collisions at $\sqrt{s}", 23, 03
"Evidence of off-shell Higgs boson production from $ZZ$ leptonic decay channels and constraints on its total width with the ATLAS detector", 23, 04
"Measurement of \ensuremath{\nu}\ensuremath{\mu} charged-current inclusive \ensuremath{\pi}0 production in the NOvA near detector", 23, 06
"Searches for supersymmetric particles with prompt decays with the ATLAS detector", 23, 06
...
"Evidence for Four-Top Quark Production at the LHC", 22, 12
"Measurement of lepton-jet correlation in deep-inelastic scattering with the H1 detector using machine learning for unfolding", 21, 08
"Unbinned Deep Learning Jet Substructure Measurement in High $Q^2$ ep collisions at HERA", 23, 03